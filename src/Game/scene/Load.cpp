...
#include "manager.h"
#include "components/CLoadBehaviour.h"
...
void Load::Setup()
{
    ...
    Transform::ScaleTo(rect2D->GetTransform(),XMFLOAT3(SCREEN_WIDTH/100.0f, SCREEN_HEIGHT/100.0f, 0.0f));
    ...
    textComponent->SetText(L"Loading...");
    ...
    text->AddComponent(new CLoadBehaviour());
